            ...
            <div class="row">
                <form action="{{ route('posts.update',$post->id) }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <textarea class="summernote" name="description">{!! old('description') ? old('description') : $post->description !!}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <select class="chosen-select" id="subcategoriesList" data-old="{{ old('subcategory_id') ? old('subcategory_id') : $post->subcategory_id }}" name="subcategory_id">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" name="date" value="{{ old('date') ? old('date') : $post->date }}" class="datepicker last_date_for_registration" data-date-format="yyyy-mm-dd">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            ...
                            @if($post->image)
                                <img src="{{ '/storage/posts/'.$post->image }}" height="200">
                            @endif
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" value="{{ old('video_url') ? old('video_url') : $post->video_url }}" name="video_url">
                        </div>
                    </div>
                    <div class="form-group">
