            ...
            <div class="row">
                <form action="{{ route('quizzes.store') }}" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group answers-block">
                        ...
                        <div class="row answer-single-block" data-type="1" style="{{ old('type') ? '' : 'display: none' }}">
                            <div class="col-md-12">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control"
                                              name="value_answer">{{ old('value_answer') }}</textarea>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="row answer-single-block" data-type="0" style="{{ is_string(old('type')) && old('type') == 0 ? '' : 'display: none' }}">
                            <input type="hidden" name="answers_count"
                                   value="{{ old('answers_count') ? old('answers_count') : 1 }}">
